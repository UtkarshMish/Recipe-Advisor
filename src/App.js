...
class App extends Component {
	...
	updateLikes = async (recommendation) => {
		return updateLikings(recommendation);
	};
					...
					<React.Fragment>
						<Switch>
							...
							<Route
								exact
								path="/dashboard"
								component={(args) => <Dashboard {...args} loggedIn={loggedIn} liked={this.updateLikes} />}
								className=" item"
							/>
							<Route path="/browse/:id?" component={Browse} className=" item" exact />

							<Route path="/logout" component={(args) => <Logout updateUser={this.updateUser} {...args} />} className=" item" exact />
							<Route path="/guide/results/q=:query?" component={RecipeFinder} className=" item" exact />

							<Route path="/guide" component={Guide} className=" item" />
							<Route
								path="/login"
								component={(args) => <Login updateUser={this.updateUser} loggedIn={loggedIn} {...args} />}
								className=" item"
								exact
							/>
							<Route path="/contact-us" component={Contact} className=" item" exact />

							<Route
								path="/signup"
								component={(args) => <Signup loggedIn={loggedIn} updateUser={this.updateUser} {...args} />}
								className=" item"
								exact
							/>
							<Route path="/browse/recipe/:id/:tab?" className=" item" component={Recipe} />
